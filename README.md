# ProcessHacker-SDK
 The SDK used for creating Process Hacker plugins

 Reuploaded here with the intention of porting it to the ARM32 architecture

 Credits to https://github.com/bfosterjr/windowsrtdev/tree/master/apps/ProcessHacker for porting several older versions to the ARM32 architecture already
